...
pub const Filter = struct {
    ...
    pub fn entityIterator(self: *@This(), comptime Components: anytype) flecs.EntityIdIterator(Components) {
        return flecs.EntityIdIterator(Components).init(self.world, flecs.ecs_filter_iter(self.world.world, self.filter), flecs.ecs_filter_next);
    }
