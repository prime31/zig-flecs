...
pub extern fn _ecs_fatal(file: [*c]const u8, line: i32, fmt: [*c]const u8, ...) void;
...
pub extern fn _ecs_assert(condition: bool, error_code: i32, condition_str: [*c]const u8, file: [*c]const u8, line: i32, fmt: [*c]const u8, ...) void;
