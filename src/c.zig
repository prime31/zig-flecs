...
pub const enum_ecs_match_kind_t = enum(c_int) {
    EcsMatchDefault = 0,
    EcsMatchAll = 1,
    EcsMatchAny = 2,
    EcsMatchExact = 3,
...
pub const enum_ecs_query_iter_kind_t = enum(c_int) {
    EcsQuerySimpleIter,
    EcsQueryPagedIter,
    EcsQuerySortedIter,
    EcsQuerySwitchIter,
...
pub const enum_EcsMatchFailureReason = enum(c_int) {
    EcsMatchOk,
    EcsMatchNotASystem,
...
pub const enum_ecs_sig_inout_kind_t = enum(c_int) {
    EcsInOut,
    EcsIn,
    EcsOut,
    _,
